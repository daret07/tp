...
class inscripcion(models.Model):
  ...
  alumno_no                      = models.IntegerField(verbose_name='Numero')
  ...
  padre_numero                   = models.IntegerField(default=0,verbose_name='Numero')
  ...
  emergencia_numero              = models.IntegerField(default=0,verbose_name='Número')
